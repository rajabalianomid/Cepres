...
namespace Cepres.Common
{
    public class Engine : IEngine
    {
        ...
        //    System.Collections.Generic.IEnumerable<Type> startupConfigurations = typeFinder.FindClassesOfType<IFileManagerStartup>();
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (ConstructorInfo constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    System.Collections.Generic.IEnumerable<object> parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                        {
                            throw new FileManagerException("Unknown dependency");
                        }
            ...
            throw new FileManagerException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
