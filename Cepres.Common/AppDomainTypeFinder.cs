...
namespace Cepres.Common
{
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IFileManagerProvider _fileProvider;
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into FileManager.
        /// </returns>
        ...
        /// <summary>Gets or sets whether FileManager should iterate assemblies in the app domain when loading FileManager types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that FileManager assemblies aren't investigated (e.g. by not including something like "^Dremlines|..." you may break core functionality.</remarks>
